...
CHEF_SERVER_NAME="ChefQA" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chefqa-vgskg94gk0hxnas7.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
